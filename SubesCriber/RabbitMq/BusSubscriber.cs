...
namespace MicroTest1.RabbitMq
{
    ...
    public interface IHandler
    {
        ...
        IHandler OnCustomError(Func<AhExeption, Task> onCustomError, bool rethrow = false);
    ...
    public class BusSubscriber : IBusSubscriber
    {
        ...
        private async Task<Acknowledgement> TryHandleAsync<TMessage>(TMessage message,
            ...
            Func<Task> handle, Func<TMessage, AhExeption, IRejectedEvent> onError = null)
        {
            ...
            return await retryPolicy.ExecuteAsync<Acknowledgement>(async () =>
            {
                ...
                catch (Exception exception)
                {
                    ...
                    if (exception is AhExeption dShopException && onError != null)
                    {
