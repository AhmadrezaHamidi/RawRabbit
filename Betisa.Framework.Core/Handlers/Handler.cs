...
namespace Betisa.Framework.Core.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<MHException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<MHException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (MHException customException)
            {
                isFailure = true;
